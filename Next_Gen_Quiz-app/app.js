...
import { select, confirm } from "@inquirer/prompts"; // For user input and selection
...
class QuizApp {
    ...
    questions;
    recentScore = null; // To store the most recent score
    recentQuestions = []; // To store the most recent questions
    constructor() {
    ...
    async getUserAnswer(question, options) {

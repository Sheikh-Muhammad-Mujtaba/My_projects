...
let myBalance = 50000; // Initial balance of the user
let myPin = 1234; // Pin number of the user
    ...
    if (pin.q1 === myPin) {
        ...
        if (operationAns.operation === "Withdraw") {
            ...
            if (amountAns.amount === "other") {
                ...
                console.log(`You withdrew $${amountAns.amount}, your new balance is $${a}`);
            }
        }
        else {
...
async function makeWithdrawal(amount) {
    // Check if there are enough funds in the account for this transaction
    if (amount > myBalance) {
        console.log(`Sorry, you do not have sufficient funds. Your current balance is ${myBalance}.`);
    }
    else {
